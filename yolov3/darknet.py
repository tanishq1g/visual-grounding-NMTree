...
class Darknet(nn.Module):
    ...
    def forward(self, x):
        ...
        for block in self.blocks:
            ...
            # print(ind, np.shape(outputs[ind]))
        # print("GHJKLHJKLBHJKL")
        # print(outno, out_boxes, out_boxes.keys(), out_boxes[0]['x'].shape, out_boxes[1]['x'].shape, out_boxes[2]['x'].shape)
        return (x, outputs[74]) if outno == 0 else (out_boxes, outputs[74])
